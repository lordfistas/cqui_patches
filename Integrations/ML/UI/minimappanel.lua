...
function CQUI_UpdateMinimapSize()
  ...
  if(CQUI_MapSize == nil) then CQUI_MapSize = 512; end
  --Cycles the minimap after resizing
  if(Controls.MinimapContainer:GetSizeX() ~= CQUI_MapSize) then
    Controls.MinimapContainer:SetSizeVal(CQUI_MapSize, CQUI_MapSize / 2);
	Controls.MinimapImage:SetSizeVal(CQUI_MapSize, CQUI_MapSize / 2);
    Controls.CollapseAnim:SetEndVal(0, Controls.MinimapContainer:GetOffsetY() + Controls.MinimapContainer:GetSizeY() + 15);
	Controls.CollapseAnim:SetEndVal(0, Controls.MinimapImage:GetOffsetY() + Controls.MinimapImage:GetSizeY() + 15);
